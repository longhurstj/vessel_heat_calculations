...
natural_cooling_data = np.loadtxt(r'C:\Users\longh\OneDrive\_uni\_Final Year Project\XCOS\natural.txt')
PID_cooling_data = np.loadtxt(r'C:\Users\longh\OneDrive\_uni\_Final Year Project\data\cycle_cooling_numerical.txt')
overshoot_data = np.loadtxt(r'C:\Users\longh\OneDrive\_uni\_Final Year Project\XCOS\overshoot.txt')
undershoot_data = np.loadtxt(r'C:\Users\longh\OneDrive\_uni\_Final Year Project\XCOS\undershoot.txt')
...
plt.figure(1)
plt.plot(PID_cooling_data[:,0], PID_cooling_data[:,1], 'b--', label = 'Kp + Ti + Td Controlled Cooling')
plt.plot(natural_cooling_data[:,0], natural_cooling_data[:,1], 'g-', label = 'Natural Convection Cooling')
plt.plot(overshoot_data[:,0], overshoot_data[:,1], label = 'Kp Gain Only')
plt.plot(undershoot_data[:,0], undershoot_data[:,1], label = 'Kp + Ti Gain Control')
t_s=np.linspace(0,2.5,num=30);
T_s=lambdify(t, eq6.rhs)
#plt.plot(t_s,T_s(t_s),'r.',  label = 'XCOS data')
